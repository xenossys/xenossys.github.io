...
var Post_0_1 = require("./posts/Post_0");
var fs = require('fs');
function Post() {
    var _this = this;
    ...
    var readFile = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    setIsLoading(true);
                    return [4 /*yield*/, fs.readFileSync("./posts/Post_1.md", 'utf8')];
                case 1:
                    data = _a.sent();
                    return [4 /*yield*/, setData(data)];
                case 2:
                    _a.sent();
                    setIsLoading(false);
                    return [2 /*return*/];
    ...
    return (react_1["default"].createElement("div", { style: {
        ...
        react_1["default"].createElement(Post_0_1["default"], null)));
}
